...
from data_utils import load_stimulus_features, load_fmri,  compute_encoding_accuracy, set_seed, atlas_schaefer
...
def setup_model_configurations(parcel_lists):
    ...
    """
    model_configs = {
        'visual': {'input_dim': 6500, 'embedding_dim': 150, 'hidden_dim': 700, 
                  'output_dim': len(parcel_lists['vis']), 'num_subjects': 4},
        'dorsattn': {'input_dim': 6500, 'embedding_dim': 150, 'hidden_dim': 700,
                    'output_dim': len(parcel_lists['dorsattn']), 'num_subjects': 4},
        'sommot': {'input_dim': 9000, 'embedding_dim': 150, 'hidden_dim': 800,
                  'output_dim': len(parcel_lists['sommot']), 'num_subjects': 4},
        'multi': {'input_dim': 5250, 'embedding_dim': 256, 'hidden_dim': 1000,
